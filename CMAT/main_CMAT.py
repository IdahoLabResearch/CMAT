...
from  optimization_window import OptimizationInputWindow
...
class MainWindow(QMainWindow):
    ...
    def process_model(self):
        ...
        # connect Manpower Optimization action
        self.process_model_window.optimization_menu.addAction('Manpower Optimization', self.optimization_model) # self.userAgreement


    def optimization_model(self):
        self.optimization_input_window = OptimizationInputWindow()
        self.optimization_input_window.show()
        self.process_model_window.hide()
        # connect the optimization window 'Back' button
        self.optimization_input_window.ui.back_btn.clicked.connect(self.optimizationWindowBackButtonAction)

    def optimizationWindowBackButtonAction(self):
        self.process_model_window.show()  # show the process model window
        self.optimization_input_window.close()  # close the optimization window
    ...
    def process_model_output(self):
        ...
        self.thread[1].start() # it will execute the run method
...
class process_model_window(QMainWindow):
    ...
    def __init__(self):
        ...
        # toolbar = self.addToolBar('Miscellaneous')
        # # To use an icon, add it in as the first argument
        # toolbar.addAction('Manpower Optimization')  #self.goToOptimizationWindow

        # menu = self.menuBar() # -> QMenuBar
        # file_menu = menu.addMenu('Optimization') # -> QMenu
        # file_menu.addAction('Manpower Optimization') # self.userAgreement
        menubar = self.menuBar() # -> QMenuBar
        font = menubar.font()
        font.setPointSize(11)  # Set the font size to 14
        menubar.setFont(font)
        self.optimization_menu = menubar.addMenu('Menu') # -> QMenu
        # self.optimization_menu.addAction('Manpower Optimization') # self.userAgreement
